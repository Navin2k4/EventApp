...
const EventDetail = async ({params:{id}}:SearchParamProps) => {
    ...
    return (
    <section className='flex justify-center bg-primary-50 bg-dotted-pattern bg-clip-content'>
        <div className='grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl'>
            ...
            <div className='flex w-full flex-col gap-8 p-5 md:p-10'>
                <div className='flex flex-col gap-6'>
                    ...
                    <div className='flex flex-col gap-3 sm:flex-row sm:items-center'>
                        <div className='flex gap-3'>
                            <p className='p-bold-20 rounded-full bg-green-500/10 px-5 py-2 text-green-700'>{event.isFree ? 'Free' : `Rs.${event.price}`}</p>
                ...
                <div className='flex flex-col gap-5'>
                    ...
                    <div className='p-regular-30 flex items-center gap-3'>
                        <Image
