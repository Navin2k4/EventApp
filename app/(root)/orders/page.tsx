  ...
  return (
    <div>
      <section className=" bg-[#c8c8c8] bg-dotted-pattern bg-cover bg-center py-5 md:py-10">
        <h3 className="wrapper h3-bold text-center sm:text-left tracking-widest">Orders</h3>
      </section>
      ...
      <section className="wrapper overflow-x-auto">
        <table className="w-full border-collapse border-t">
          <thead>
            <tr className="p-medium-14 border-b text-black tracking-widest">
              <th className="min-w-[250px] py-3 text-left">Order ID</th>
              <th className="min-w-[200px] flex-1 py-3 pr-4 text-left">Event Title</th>
              <th className="min-w-[150px] py-3 text-left">Buyer</th>
              <th className="min-w-[150px] py-3 text-left">Mail</th>
              <th className="min-w-[100px] py-3 text-left">Credited On</th>
                ...
                {orders &&
                  orders.map((row: IOrderItem) => (
                    <tr
                      ...
                      <td className="min-w-[150px] py-4">{row.buyerMail}</td>
